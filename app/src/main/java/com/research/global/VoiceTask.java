...
public class  VoiceTask  <T> extends  AsyncTask<Object, Object, Object> implements EntityCallBack{
	...
	public VoiceTask(AbstractHttpClient client, HttpContext context, AjaxCallBack<T> callback) {
		this.client = client;
