...
public class CompleteUserInfoActvity extends BaseActivity implements OnClickListener{
	...
	private static final String TAG = "CompleteUserInfoActvity";
	...
	private void getImageFromCamera() {
		...
		if(FeatureFunction.newFolder(Environment.getExternalStorageDirectory() + FeatureFunction.PUB_TEMP_DIRECTORY)){
			...
			startActivityForResult(getImageByCamera, GlobalParam.REQUEST_GET_IMAGE_BY_CAMERA);
		}
	...
	private void getImageFromGallery() {
		...
		startActivityForResult(intent, GlobalParam.REQUEST_GET_URI);*/	 //bug:第一次图片不显示,第二次图片闪退
