...
public class AudioRecorderAction extends BaseAction {
	...
	public static final int MOVE_REMOVE = -1;
	public static final int SUCCESS = 0;
	public static int STATE = SUCCESS;
	...
	public void stopRecord() throws IOException {
		...
		if(recordStart == RECOREDER_ING){
			...
			try {
				...
				if (STATE == MOVE_REMOVE){
					delRecord();
					recordPath = mContext.getString(R.string.move_remove);
				}
	...
	public void udapteState(int STATE){
		this.STATE = STATE;
	}
}
